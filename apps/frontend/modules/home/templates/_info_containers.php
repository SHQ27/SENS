...
<div id='flota-info' class='info-container'>
    <img src="img/empresas.png">
    <h1>FLOTA AUTOMOTOR</h1>
    <p>Mediante la observación del programa de seguros actual y la elaboración de recomendaciones asociadas consiga en Sens la propuesta de seguros más competitiva.</p>
</div>
<div id="art-info" class='info-container'>
    <img src="img/empresas.png">
    <h1>A.R.T.</h1>
    <p>Alcance una mayor rentabilidad en su negocio. La elección de aseguradoras distinguidas y especializadas en la prestación del seguro de cobertura de riesgos del trabajo contribuirá a que usted y su grupo de trabajo obtengan los mejores resultados en un ambiente de trabajo más sano, seguro y productivo.</p>
</div>
<div id="indu-agro-info" class='info-container'>
    <img src="img/empresas.png">
    <h1>SEGUROS INDUSTRALES <br> Y AGROPECUARIOS</h1>
    <p>Por medio de la identificación y estudio de los riesgos reales que afronta cada cliente, otorgamos coberturas justas adecuadas a la realidad evitando el pago de una extra prima.</p>
</div>
<div id="int-comercio-info" class='info-container'>
    <img src="img/empresas.png">
    <h1>INTEGRALES DE COMERCIO</h1>
    <p>Asegure su comercio eficientemente y con el análisis que merece. Realizamos la revisión e interpretación continua de las coberturas y condiciones que implica cada contrato.</p>
</div>
<div id="int-consorcio-info" class='info-container'>
    <img src="img/empresas.png">
    <h1>INTEGRALES DE CONSORCIO</h1>
    <p>Realizamos sugerencias y consejos de seguros para administradores de consorcios a través de un servicio personalizado.
    </p>
</div>
...
<div id="transporte-info" class='info-container'>
    <img src="img/empresas.png">
    <h1>TRANSPORTE</h1>
    <p>Adquiera en Sens, seguros de transporte internacional y nacional de mercadería, ofreciendo un servicio de excelencia.</p>
</div>
